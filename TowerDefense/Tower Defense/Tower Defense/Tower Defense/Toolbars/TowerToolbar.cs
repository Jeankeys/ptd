    ...
    class TowerToolbar
    {
        ...
        private void evolve(object sender, EventArgs e)
        {
            if (sender == charmeleonButton) //Charmander
            {
                ...
                { player.towers[index].texture = charmeleonTexture2; ++player.towers[index].evolution; }
            }
            if (sender == charizardButton) 
            {
                ...
                { player.towers[index].texture = charizardTexture2; ++player.towers[index].evolution; }
            }
            if (sender == wartortleButton) //Squirtle
            {
                if (player.towers[index].Evolution == 1 && player.towers[index].level >= 16 && player.Money >= player.towers[index].EvolutionOneCost)
                { player.towers[index].texture = wartortleTexture2; ++player.towers[index].evolution; }
            }
            if (sender == blastoiseButton) 
            {
                if (player.towers[index].Evolution == 2 && player.towers[index].level >= 36 && player.Money >= player.towers[index].EvolutionTwoCost)
                { player.towers[index].texture = blastoiseTexture2; ++player.towers[index].evolution; }
            }
            if (sender == ivysaurButton) //Bulbasaur
            {
                if (player.towers[index].Evolution == 1 && player.towers[index].level >= 16 && player.Money >= player.towers[index].EvolutionOneCost)
                { player.towers[index].texture = ivysaurTexture2; ++player.towers[index].evolution; }
            }
            if (sender == venusaurButton) 
            {
                ...
                { player.towers[index].texture = venusaurTexture2; ++player.towers[index].evolution; }
            }
            if (sender == raichuButton) //Pikachu
            {
                if (player.towers[index].Evolution == 1 && player.Money >= player.towers[index].EvolutionOneCost)
                { player.towers[index].texture = raichuTexture2; ++player.towers[index].evolution; }
            }

            if (sender == wigglytuffButton) //Jigglypuff
            {
                if (player.towers[index].Evolution == 1 && player.Money >= player.towers[index].EvolutionOneCost)
                { player.towers[index].texture = wigglytuffTexture2; ++player.towers[index].evolution; }
            }
            ...
            if (sender == dragonairButton) //Dratini
            {
                ...
                { player.towers[index].texture = dragonairTexture2; ++player.towers[index].evolution; }
            }
            if (sender == dragoniteButton) 
            {
                ...
                { player.towers[index].texture = dragoniteTexture2; ++player.towers[index].evolution; }
            }
            ...
            if (sender == mewtwoButton) //Mew
            {
                ...
                { player.towers[index].texture = mewtwoTexture2; ++player.towers[index].evolution; }
            }
        }
