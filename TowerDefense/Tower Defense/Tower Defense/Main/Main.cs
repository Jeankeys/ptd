...
namespace Tower_Defense
{
    ...
    public class Main : Microsoft.Xna.Framework.Game
    {
        ...
        public static SoundEffectInstance openingInstance;
        public static SoundEffect opening;
        ...
        protected override void Initialize()
        {
            ...
            GameOverScreen = Content.Load<Texture2D>(@"Images\Levels\Buried Alive");
            ...
            opening = Content.Load<SoundEffect>(@"Audio\opening");
            ...
            openingInstance = opening.CreateInstance();
        ...
        public static void LoadAll()
        {
            ...
            waveManager = new WaveManager(player, level, 101, enemyTextures);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            switch (currentGameState)
            {
                ...
                case GameState.LevelSelect:
                    { levelSelectScreen.Update(gameTime); songTime = 0; break; }
                ...
                case GameState.GameOver:
                    {
                        ...
                        spriteBatch.Draw(GameOverScreen, new Rectangle(0, 0, Window.ClientBounds.Width, Window.ClientBounds.Height), null,
                                         Color.White, 0, Vector2.Zero, SpriteEffects.None, 0);
